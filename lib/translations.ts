...
const vi: Translations = {
  ...
  hero: {
    ...
    description:
      'Hệ thống sân có mái che. Dịch vụ vệ sinh dụng cụ miễn phí. Café thư giãn sau trận đấu. Tại Courtyard, hãy để chúng tôi lo mọi thứ, việc của bạn là tận hưởng cuộc chơi.',
