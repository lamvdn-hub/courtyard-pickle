...
const vi: Translations = {
  ...
  hero: {
    ...
    description:
      'Hệ thống sân có mái che. Cho mượn vợt, bóng và vệ sinh dụng cụ miễn phí. Trái cây giải khát ngay trong trận. Café thư giãn sau trận đấu. Tại Courtyard, hãy để chúng tôi lo mọi thứ để bạn có thể tận hưởng cuộc chơi.',
